        ...
        <div class="hero-wrap d-flex align-items-center h-100">
          ...
          <div class="hero-content mx-auto w-100 h-100 d-flex flex-column">
            ...
            <div class="row g-0 my-auto">
              <div class="col-10 col-lg-9 mx-auto">
                <h1 class="text-11 text-white mb-4">Get Started!</h1>
            ...
            <div class="col-11 col-lg-9 col-xl-8 mx-auto">
              ...
              <form id="loginForm" method="post">
				...
				<div class="mb-3">
                  ...
                  <input type="text" name ="mobile" class="form-control" id="mobile" required placeholder="Enter Your Name">
                </div>
                
                <div class="d-grid mt-4 mb-3"><button name="submit_step1" class="btn btn-primary" type="submit">Next Step</button></div>
              </form>
