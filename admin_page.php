        ...
        <div class="header-column justify-content-end"> 
          ...
          <nav class="login-signup navbar navbar-expand">
            <ul class="navbar-nav">
              ...
              <li class="dropdown profile ms-2"> <a class="px-0 dropdown-toggle" href="#"><a href="logout.php">LogOut</a>
...
if (class_exists('DATABASE_CONNECT')) {
    ...
    if ($conn->connect_error) {
        ...
        $sql_details_user = "SELECT lastname, firstname, account_number, account_balance, account_type, dob
                             FROM customers
                             ORDER BY user_id ASC"; // Modify this line to sort by ID
        ...
        if ($result_details_user->num_rows > 0) {
            ...
            while ($row_details_user = $result_details_user->fetch_assoc()) {
                ...
                $account_type = $row_details_user['account_type'];
...
?>
          ...
          <div class="bg-white shadow-sm rounded py-8 mb-8">
            
            <!-- Title
            =============================== -->
            <div class="transaction-title py-2 px-4">
              <div class="row fw-00">
                <div class="col-auto col-sm-2 d-none d-sm-block text-center">Firstname</div>

                <div class="col-auto col-sm-2 d-none d-sm-block text-center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Lastname</div>
				<div class="col-auto col-sm-2 d-none d-sm-block text-center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DOB</div>
				<div class="col-auto col-sm-2 d-none d-sm-block text-center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Acc Number</div>
                <div class="col-auto col-sm-2 d-none d-sm-block text-center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Balance</div>
...
if (!empty($users)) {
    foreach ($users as $user) {
        ...
        echo "<div class='transaction-list'>
              <div class='transaction-item px-1 py-1' data-bs-toggle='modal' data-bs-target='#transaction-detail'>
                <div class='row align-items-center flex-row'>
                  <div class='col col-sm-2'> <span class='d-block text-4 fw-300'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$firstname</span> </div>
                  <div class='col col-sm-2'> <span class='d-block text-4'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$lastname</span> </div>
                  <div class='col col-sm-2'> <span class='text-nowrap'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$dob</span> </div>
                  <div class='col col-sm-2'> <span class='text-nowrap'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$acc_number</span> </div>
                  <div class='col col-sm-2'> <span class='text-nowrap'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$acc_bal</span> </div>
                  <div class='col col-sm-2'> <span class='text-nowrap'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$account_type</span> </div>
                </div>
              </div>
            </div>";
    }
