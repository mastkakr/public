...
if (isset($_SESSION['transfer']) && $_SESSION['transfer'] === true) {
    ...
    if (isset($_POST['transfer3'])) {
        // Redirect to "transfer_auth.php" when the "transfer3" form is submitted
        $newUrl = "transfer.php";
        header("Location: $newUrl");
        exit; // Don't forget to exit to prevent further execution
    }
} else {
    // Redirect to "dashboard.php" if the 'transfer' session is not active
...
<div id="main-wrapper"> 
  ...
  <div id="content" class="py-4">
    <div class="container"> 
      ...
      <h2 class="fw-400 text-center mt-3 mb-4">Withdrawal Completed</h2>
      <div class="row">
        ...
        ============================================= -->
          <div class="bg-white text-center shadow-sm rounded p-3 pt-sm-4 pb-sm-5 px-sm-5 mb-4">
            <div class="my-4">
              ...
              <p class="lead">Transactions Completed</p>
            </div>
            <p class="text-3 mb-4">You've successfully withdrawn <span class="text-4 fw-500">$<?php echo $amnt; ?></span>  See transaction details under <a class="btn-link" href="#">Activity</a>.</p>
            <div class="d-grid"><a href="transfer.php"><button name="transfer3" class="btn btn-primary">Withdraw Money Again</button></a></div>
