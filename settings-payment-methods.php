...
if (class_exists('DATABASE_CONNECT')) {
    ...
    if ($conn->connect_error) {
        ...
        $sql_details_user = "SELECT lastname, firstname, account_number, account_balance, dob, address, zip, state, city, email, mobile_number
                             FROM customers
                             WHERE email = '$email'";
		...
		$dob = $row_details_user['dob'];
		$add = $row_details_user['address'];
		$city = $row_details_user['city'];
		$zip = $row_details_user['zip'];
		$stat = $row_details_user['state'];
		$email = $row_details_user['email'];
		$mobile = $row_details_user['mobile_number'];
    ...
    <div class="container">
      <div class="header-row">
        <div class="header-column justify-content-start"> 
          <!-- Logo
          ============================= -->
          <div class="logo me-3"> <a class="d-flex" href="#" title="First National Bank"><img src="images/logo2.png" alt="First National Bank" /></a> </div>
          <!-- Logo end --> 
          <!-- Collapse Button
          ============================== -->
  ...
  <div class="bg-primary">
    <div class="container d-flex justify-content-center">
      <ul class="nav nav-pills alternate nav-lg border-bottom-0">
        ...
        <li class="nav-item"> <a class="nav-link active" href="settings-payment-methods.php">Payment Methods</a></li>
        <li class="nav-item"> <a class="nav-link" href="settings-notifications.php">Notifications</a></li>
      </ul>
    </div>
  </div>
  <!-- Secondary menu end --> 
      ...
      <div class="row"> 
        ...
        <aside class="col-lg-3"> 
          ...
          <div class="bg-white shadow-sm rounded text-center p-3 mb-4">
            ...
            <hr class="mx-n3">
            <div class="d-flex"><h5 class="text-5 fw-200">Business Checking  </h5></div>
          </div>
          ...
          <div class="bg-white shadow-sm rounded text-center p-3 mb-4">
            ...
            <div class="d-grid"><a href="contact-us.php" class="btn btn-primary">Chat with Us</a></div>
		  </div>
          <!-- Need Help? End --> 
            ...
            <div class="row g-3">
              <div class="col-12 col-md-6 col-lg-4">
                <div class="account-card account-card-primary text-white rounded p-3">
                  ...
                  <p class="d-flex align-items-center"> <span class="account-card-expire text-uppercase d-inline-block opacity-7 me-2">Valid<br>
                    thru<br>
                    </span> <span class="text-4 opacity-9">07/26</span> <span class="badge bg-warning text-dark text-0 fw-500 rounded-pill px-2 ms-auto">Primary</span> </p>
                  <p class="d-flex align-items-center m-0"> <span class="text-uppercase fw-500"><?php echo $firstname.  '  '  .$lastname; ?></span> <img class="ms-auto" src="images/payment/visa.png" alt="visa" title=""> </p>
              ...
              <div class="col-12 col-md-6 col-lg-4">
                <div class="account-card text-white rounded p-3">
                  ...
                  <p class="d-flex align-items-center"> <span class="account-card-expire text-uppercase d-inline-block opacity-7 me-2">Valid<br>
                    thru<br>
                    </span> <span class="text-4 opacity-9">08/24</span> </p>
                  <p class="d-flex align-items-center m-0"> <span class="text-uppercase fw-500"><?php echo $firstname.  '  '  .$lastname; ?></span> <img class="ms-auto" src="images/payment/mastercard.png" alt="mastercard" title=""> </p>
                  <div class="account-card-overlay rounded"> <a href="#" data-bs-target="#edit-card-details" data-bs-toggle="modal" class="text-light btn-link mx-2"><span class="me-1"><i class="fas fa-edit"></i></span>Edit</a> <a href="#" class="text-light btn-link mx-2"><span class="me-1"><i class="fas fa-minus-circle"></i></span>Delete</a> </div>
                </div>
              </div>
                ...
                <div class="account-card account-card-primary text-white rounded">
                  <div class="row g-0">
					...
					<div class="py-4 my-2 ps-4">
                        <p class="text-4 fw-500 mb-1">First National Bank</p>
                        <p class="text-4 opacity-9 mb-1">XXXXXXXXXXXX-<?php echo $lastFourDigits; ?></p>
