  ...
  <div class="bg-primary">
    <div class="container d-flex justify-content-center">
      <ul class="nav nav-pills alternate nav-lg border-bottom-0">
        <li class="nav-item"> <a class="nav-link active" href="settings-profile.php">Account</a></li>
      ...
      <div class="row"> 
        ...
        <aside class="col-lg-3"> 
          ...
          <div class="bg-white shadow-sm rounded text-center p-3 mb-4">
            ...
            <p class="text-3 fw-500 mb-2"> <?php echo $firstname. ' ' .$lastname;?></p>
          ...
          =============================== -->
          <div class="bg-white shadow-sm rounded text-center p-3 mb-4">
		     <h3 class="text-5 fw-200">Current Information</h3>
        ...
        <div class="col-lg-9"> 
          ...
          <div class="bg-white shadow-sm rounded p-4 mb-4">
            ...
            <div class="row gx-3 align-items-center">
              ...
              <p class="col-sm-9 text-3"><?php echo $firstname. ' ' .$lastname; ?></p>
            </div>
            <div class="row gx-3 align-items-center">
              <p class="col-sm-3 text-muted text-sm-end mb-0 mb-sm-3">Date of Birth:</p>
              <p class="col-sm-9 text-3"><?php echo $dob; ?></p>
            </div>
            <div class="row gx-3 align-items-baseline">
              <p class="col-sm-3 text-muted text-sm-end mb-0 mb-sm-3">Address:</p>
              <p class="col-sm-9 text-3"><?php echo $add.'<br>'.
               $city.','.'<br>'.
                $stat.'-'.$zip.','.'<br>'; ?>
                United States.</p>
            </div>
          ...
          <div class="bg-white shadow-sm rounded p-4 mb-4">
            ...
            <div class="row gx-3 align-items-center">
              ...
              <p class="col-sm-9 text-3 d-sm-inline-flex d-md-flex align-items-center"><?php echo $email; ?><span class="badge bg-info text-1 fw-500 rounded-pill px-2 py-1 ms-2">Primary</span></p>
            </div>
          ...
          <div class="bg-white shadow-sm rounded p-4 mb-4">
            ...
            <div class="row gx-3 align-items-center">
              ...
              <p class="col-sm-9 text-3 align-items-center d-sm-inline-flex d-md-flex"><?php echo $mobile; ?><span class="badge bg-info text-1 fw-500 rounded-pill px-2 py-1 ms-2">Primary</span></p>
            </div>
