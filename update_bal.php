    ...
    if (class_exists('SECURE_INPUT_DATA_AVAILABLE')) {
        ...
        if (class_exists('DATABASE_CONNECT')) {
            ...
            if ($conn->connect_error) {
                ...
                $update_sql = "UPDATE customers SET account_balance = ? WHERE email = ?";
                ...
                // Bind the parameters
                $update_stmt->bind_param("ds", $amt, $email);
    ...
    <div class="row g-0">
      <div class="col-11 col-sm-9 col-md-7 col-lg-5 col-xl-4 m-auto py-5">
        ...
        <form id="loginForm" method="post">
          ...
          <div class="d-grid my-4"><button class="btn btn-primary shadow-none" type="submit" name="update3">Update Balance</button></div>
        </form>
